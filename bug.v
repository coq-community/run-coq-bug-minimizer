...
(* File reduced by coq-bug-finder from original input, then from 2099 lines to 52 lines, then from 134 lines to 412 lines, then from 416 lines to 215 lines, then from 297 lines to 2315 lines, then from 2314 lines to 382 lines, then from 460 lines to 1640 lines, then from 1641 lines to 736 lines, then from 811 lines to 2862 lines, then from 2865 lines to 1296 lines, then from 1360 lines to 1860 lines, then from 1863 lines to 1306 lines, then from 1337 lines to 1576 lines, then from 1580 lines to 1341 lines, then from 1365 lines to 1427 lines, then from 1431 lines to 1359 lines, then from 1383 lines to 1467 lines, then from 1471 lines to 1366 lines, then from 1388 lines to 1829 lines, then from 1832 lines to 1383 lines, then from 1403 lines to 1508 lines, then from 1511 lines to 1440 lines *)
...
Module Export Rewriter_DOT_Util_DOT_Tactics_DOT_DestructHead_WRAPPED.
Module Export DestructHead.
Export Rewriter.Util.FixCoqMistakes.
Import Rewriter.Util.Tactics.Head.
Import Rewriter.Util.Tactics.DestructHyps.
...
End Rewriter_DOT_Util_DOT_Tactics_DOT_DestructHead_WRAPPED.
Module Export Rewriter_DOT_Util_DOT_Tactics_DOT_DestructHead.
Module Export Rewriter.
Module Export Util.
Module Export Tactics.
Module Export DestructHead.
Include Rewriter_DOT_Util_DOT_Tactics_DOT_DestructHead_WRAPPED.DestructHead.
End DestructHead.
