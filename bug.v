...
(* File reduced by coq-bug-minimizer from original input, then from 717 lines to 555 lines, then from 568 lines to 1468 lines, then from 1472 lines to 694 lines, then from 703 lines to 575 lines, then from 588 lines to 979 lines, then from 982 lines to 820 lines, then from 833 lines to 1403 lines, then from 1408 lines to 969 lines, then from 971 lines to 832 lines, then from 845 lines to 991 lines, then from 996 lines to 851 lines, then from 864 lines to 888 lines, then from 893 lines to 967 lines, then from 973 lines to 854 lines, then from 867 lines to 924 lines, then from 929 lines to 862 lines, then from 875 lines to 967 lines, then from 972 lines to 897 lines, then from 906 lines to 872 lines, then from 885 lines to 1355 lines, then from 1360 lines to 1170 lines, then from 1183 lines to 1590 lines, then from 1595 lines to 1372 lines, then from 1374 lines to 1256 lines, then from 1269 lines to 1703 lines, then from 1708 lines to 1347 lines, then from 1360 lines to 1696 lines, then from 1701 lines to 1472 lines, then from 1474 lines to 1354 lines, then from 1367 lines to 1695 lines, then from 1700 lines to 1390 lines, then from 1403 lines to 1448 lines, then from 1453 lines to 1531 lines, then from 1533 lines to 1400 lines, then from 1413 lines to 1973 lines, then from 1975 lines to 1495 lines, then from 1503 lines to 1468 lines, then from 1481 lines to 1922 lines, then from 1926 lines to 1496 lines, then from 1505 lines to 1478 lines, then from 1491 lines to 1880 lines, then from 1885 lines to 1673 lines, then from 1686 lines to 1673 lines, then from 1686 lines to 2008 lines, then from 2013 lines to 1700 lines, then from 1713 lines to 1979 lines, then from 1984 lines to 1904 lines, then from 1906 lines to 1733 lines, then from 1746 lines to 1933 lines, then from 1938 lines to 1743 lines, then from 1756 lines to 1943 lines, then from 1948 lines to 2036 lines, then from 2038 lines to 1741 lines, then from 1754 lines to 1784 lines, then from 1789 lines to 1746 lines, then from 1759 lines to 1782 lines, then from 1787 lines to 1833 lines, then from 1838 lines to 1748 lines, then from 1761 lines to 1777 lines, then from 1782 lines to 1754 lines, then from 1767 lines to 1810 lines, then from 1815 lines to 1873 lines, then from 1875 lines to 1771 lines, then from 1784 lines to 2472 lines, then from 2471 lines to 2067 lines, then from 2071 lines to 2058 lines, then from 2071 lines to 2109 lines, then from 2114 lines to 2073 lines, then from 2086 lines to 2162 lines, then from 2167 lines to 2114 lines, then from 2119 lines to 2099 lines, then from 2112 lines to 2175 lines, then from 2180 lines to 2115 lines, then from 2128 lines to 2166 lines, then from 2171 lines to 2154 lines, then from 2161 lines to 2124 lines, then from 2137 lines to 2311 lines, then from 2316 lines to 2192 lines, then from 2205 lines to 2365 lines, then from 2370 lines to 2356 lines, then from 2358 lines to 2277 lines, then from 2290 lines to 2324 lines, then from 2329 lines to 2286 lines, then from 2299 lines to 2398 lines, then from 2403 lines to 2444 lines, then from 2446 lines to 2345 lines, then from 2358 lines to 2392 lines, then from 2397 lines to 2457 lines *)
(* coqc version 8.16+alpha compiled with OCaml 4.13.0
   ...
   Expected coqc runtime on this file: 30.446 sec *)
...
Module Export coqutil_DOT_Tactics_DOT_eabstract_WRAPPED.
Module Export eabstract.
...
End coqutil_DOT_Tactics_DOT_eabstract_WRAPPED.
Module Export coqutil_DOT_Tactics_DOT_eabstract.
Module Export coqutil.
Module Export Tactics.
Module Export eabstract.
Include coqutil_DOT_Tactics_DOT_eabstract_WRAPPED.eabstract.
End eabstract.
...
End coqutil_DOT_Tactics_DOT_eabstract.
Axiom proof_admitted : False.
Tactic Notation "admit" := abstract case proof_admitted.
...
Proof.
    do 1000 ltac1:(intro_as_string "ab_cdef_gh"; revert ab_cdef_gh).
...
Section SepProperties.
  ...
  Global Instance Proper_sep_iff1 : Proper (@iff1 map ==> iff1 ==> iff1) sep.
Admitted.
