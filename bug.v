...
(* File reduced by coq-bug-minimizer from original input, then from 203 lines to 268 lines, then from 260 lines to 255 lines *)
(* coqc version 8.17+alpha compiled with OCaml 4.09.0
   ...
   Expected coqc runtime on this file: 3.656 sec *)
