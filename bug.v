...
(* File reduced by coq-bug-minimizer from original input, then from 182 lines to 48 lines, then from 61 lines to 167 lines, then from 172 lines to 75 lines, then from 88 lines to 269 lines, then from 274 lines to 84 lines, then from 97 lines to 337 lines, then from 342 lines to 85 lines, then from 98 lines to 85 lines, then from 98 lines to 85 lines, then from 98 lines to 85 lines, then from 98 lines to 85 lines *)
(* coqc version 8.15+alpha compiled with OCaml 4.05.0
   ...
   Expected coqc runtime on this file: 15.058 sec *)
