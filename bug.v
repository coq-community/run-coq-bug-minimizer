...
(* coqc version 8.20+alpha compiled with OCaml 4.14.1
   ...
   Expected coqc runtime on this file: 5.837 sec *)
...
Module mathcomp_DOT_ssreflect_DOT_ssrbool_WRAPPED.
Module ssrbool.
Import mathcomp.ssreflect.ssreflect mathcomp.ssreflect.ssrfun.
...
Proof.
by apply:(iffP negP); apply: contra_not => /rP.
Qed.
...
End mathcomp_DOT_ssreflect_DOT_ssrbool_WRAPPED.
Module Export mathcomp_DOT_ssreflect_DOT_ssrbool.
Module Export mathcomp.
Module Export ssreflect.
Module ssrbool.
Include mathcomp_DOT_ssreflect_DOT_ssrbool_WRAPPED.ssrbool.
End ssrbool.
...
End mathcomp_DOT_ssreflect_DOT_ssrbool.
