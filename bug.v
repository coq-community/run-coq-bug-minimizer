...
(* coqc version 8.20+alpha compiled with OCaml 4.14.1
   ...
   Expected coqc runtime on this file: 7.827 sec *)
...
Reserved Notation "0%O" (at level 0).

Reserved Notation "1%O" (at level 0).
...
Reserved Notation "0^d%O" (at level 0).

Reserved Notation "1^d%O" (at level 0).
...
Definition le : rel T.
exact (POrder.le (POrder.class T)).
Defined.
Local Notation "x <= y" := (le x y) : order_scope.
Definition lt : rel T.
Admitted.
Local Notation "x < y" := (lt x y) : order_scope.
Definition comparable : rel T.
Admitted.
Local Notation "x >=< y" := (comparable x y) : order_scope.
Local Notation "x >< y" := (~~ (x >=< y)) : order_scope.
Definition ge : simpl_rel T.
exact ([rel x y | y <= x]).
Defined.
Definition gt : simpl_rel T.
Admitted.
...
exact (Lattice.meet (Lattice.class T)).
Defined.
Definition join : T -> T -> T.
exact (Lattice.join (Lattice.class T)).
Defined.
...
Notation "0%O" := bottom (only parsing).
...
Module Export DistrLatticeMixin.
...
Module Export CBDistrLatticeMixin.
...
Module Export CTBDistrLatticeMixin.
...
Module Export DistrLatticePOrderMixin.
...
Module Export TotalLatticeMixin.
...
Module Export TotalPOrderMixin.
...
Module Export NatMonotonyTheory.
...
Module Export DvdSyntax.

End DvdSyntax.

Module Export NatDvd.
Section NatDvd.
...
Module Export DefaultProdOrder.
Section DefaultProdOrder.

End DefaultProdOrder.
End DefaultProdOrder.

Module Export SigmaOrder.
Section SigmaOrder.
...
Module Export DefaultProdLexiOrder.
Section DefaultProdLexiOrder.

End DefaultProdLexiOrder.
End DefaultProdLexiOrder.

Module Export SeqProdOrder.
...
Module Export DefaultSeqProdOrder.
Section DefaultSeqProdOrder.

End DefaultSeqProdOrder.
End DefaultSeqProdOrder.

Module Export SeqLexiOrder.
...
Module Export DefaultSeqLexiOrder.
Section DefaultSeqLexiOrder.

End DefaultSeqLexiOrder.
End DefaultSeqLexiOrder.

Module Export TupleProdOrder.
...
Module Export DefaultTupleProdOrder.
Section DefaultTupleProdOrder.

End DefaultTupleProdOrder.
End DefaultTupleProdOrder.

Module Export TupleLexiOrder.
...
Module Export DefaultTupleLexiOrder.
...
Module Export DefaultSetSubsetOrder.
...
Module Export LTheory.
End LTheory.

Module Export CTheory.
End CTheory.

Module Export TTheory.
End TTheory.
