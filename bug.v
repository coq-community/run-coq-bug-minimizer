...
(* File reduced by coq-bug-finder from original input, then from 213 lines to 48 lines, then from 90 lines to 173 lines, then from 178 lines to 75 lines, then from 116 lines to 279 lines, then from 284 lines to 84 lines, then from 125 lines to 337 lines, then from 342 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines, then from 125 lines to 85 lines *)
(* coqc version 8.15+alpha compiled with OCaml 4.05.0
   ...
   Expected coqc runtime on this file: 20.100 sec *)
