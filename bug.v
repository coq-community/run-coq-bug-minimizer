...
(* File reduced by coq-bug-minimizer from original input, then from 717 lines to 555 lines, then from 568 lines to 1468 lines, then from 1472 lines to 694 lines, then from 703 lines to 575 lines, then from 588 lines to 979 lines, then from 982 lines to 820 lines, then from 833 lines to 1403 lines, then from 1408 lines to 969 lines, then from 971 lines to 832 lines, then from 845 lines to 991 lines, then from 996 lines to 851 lines, then from 864 lines to 888 lines, then from 893 lines to 967 lines, then from 973 lines to 854 lines, then from 867 lines to 924 lines, then from 929 lines to 862 lines, then from 875 lines to 967 lines, then from 972 lines to 897 lines, then from 906 lines to 872 lines, then from 885 lines to 1355 lines, then from 1360 lines to 1170 lines, then from 1183 lines to 1590 lines, then from 1595 lines to 1372 lines, then from 1374 lines to 1256 lines, then from 1269 lines to 1703 lines, then from 1708 lines to 1347 lines, then from 1360 lines to 1696 lines, then from 1701 lines to 1472 lines *)
(* coqc version 8.16+alpha compiled with OCaml 4.13.0
   ...
   Expected coqc runtime on this file: 23.791 sec *)
...
Module Export bedrock2_DOT_ptsto_bytes_WRAPPED.
Module Export ptsto_bytes.
Import coqutil.Map.Interface.
Import coqutil.Map.Properties.
...
Definition ptsto_bytes (n : nat) (addr : word) (value : tuple byte n) : mem -> Prop. exact (array ptsto (word.of_Z 1) addr (tuple.to_list value)). Defined.
End Scalars.
