...
(* File reduced by coq-bug-minimizer from original input, then from 5422 lines to 262 lines, then from 275 lines to 6956 lines, then from 6961 lines to 4136 lines *)
(* coqc version 8.16+alpha compiled with OCaml 4.13.0
   ...
   Expected coqc runtime on this file: 1.702 sec *)
