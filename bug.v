...
(* File reduced by coq-bug-minimizer from original input, then from 203 lines to 268 lines, then from 260 lines to 255 lines, then from 260 lines to 255 lines, then from 260 lines to 255 lines, then from 260 lines to 255 lines, then from 260 lines to 255 lines, then from 260 lines to 173 lines, then from 178 lines to 173 lines, then from 178 lines to 185 lines, then from 188 lines to 185 lines, then from 188 lines to 183 lines, then from 188 lines to 184 lines, then from 188 lines to 185 lines, then from 188 lines to 183 lines, then from 188 lines to 183 lines *)
