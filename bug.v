...
(* coqc version 8.16+alpha compiled with OCaml 4.13.0
   ...
   Expected coqc runtime on this file: 1.578 sec *)
...
exact (fun a b c : key -> t' => forall x, join (a x) (b x) (c x)).
Defined.
End SepAlgFun.
