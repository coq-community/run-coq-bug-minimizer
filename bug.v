...
(* coqc version 8.20+alpha compiled with OCaml 4.09.0
   ...
   Expected coqc runtime on this file: 1.810 sec *)
...
Module Export MetaCoq_DOT_Utils_DOT_MCCompare_WRAPPED.
Module Export MCCompare.
...
End MetaCoq_DOT_Utils_DOT_MCCompare_WRAPPED.
Module Export MetaCoq_DOT_Utils_DOT_MCCompare.
Module Export MetaCoq.
Module Export Utils.
Module Export MCCompare.
Include MetaCoq_DOT_Utils_DOT_MCCompare_WRAPPED.MCCompare.
End MCCompare.
...
End MetaCoq_DOT_Utils_DOT_MCCompare.
Axiom proof_admitted : False.
Tactic Notation "admit" := abstract case proof_admitted.
