...
Require Coq.Init.Wf.
Module Export Fiat_DOT_Common_DOT_Wf_WRAPPED.
Module Export Wf.
...
End Fiat_DOT_Common_DOT_Wf_WRAPPED.
Module Export Fiat_DOT_Common_DOT_Wf.
Module Export Fiat.
Module Export Common.
Module Export Wf.
Include Fiat_DOT_Common_DOT_Wf_WRAPPED.Wf.
End Wf.
...
Module Export Fiat_DOT_Common_DOT_FMapExtensions_DOT_Wf.
Module Export Fiat.
Module Export Common.
Module Export FMapExtensions.
Module Wf.
Export Coq.FSets.FMapInterface.
Export Fiat.Common.FMapExtensions.LiftRelationInstances.
Import Fiat.Common.
...
End Fiat_DOT_Common_DOT_FMapExtensions_DOT_Wf.
...
Global Instance and_iff_iff_iff_Proper : Proper (iff ==> iff ==> iff) and | 1
  := _.
Module Fiat_DOT_Common_DOT_MSetExtensions_WRAPPED.
...
End Fiat_DOT_Common_DOT_MSetExtensions_WRAPPED.
Module Export Fiat.
Module Export Common.
Module MSetExtensions.
Include Fiat_DOT_Common_DOT_MSetExtensions_WRAPPED.MSetExtensions.
End MSetExtensions.
